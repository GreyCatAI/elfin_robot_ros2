...
def generate_launch_description():
    ...
    joint_limits_yaml = {
        "robot_description_planning": load_yaml(
            "elfin5_ros2_moveit2", "config/joint_limits.yaml"
        )
    }
    ...
    rviz_base = os.path.join(
        get_package_share_directory("elfin5_ros2_moveit2"), "launch"
    )
    rviz_full_config = os.path.join(rviz_base, "elfin5_moveit2.rviz")
    rviz_node_full = Node(
        package="rviz2",
        executable="rviz2",
        name="rviz2",
